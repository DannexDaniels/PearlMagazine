var Layout=function(){
	...
	o=function(){
		...
		t=$(".navbar-fixed-top").height()-20,$(".js_nav-item a").bind("click",function(o){
			...
			$("html, body").stop().animate({scrollTop:a-t},600),o.preventDefault()
		});
		$("body").scrollspy({
			target:".navbar-fixed-top",offset:t+2
		});
		$(window).scroll(function(){
	...
	a=function(){
		var t=$(".carousel .item"),o=$(window).height();
		...
		$(".carousel img").each(function(){
			...
			$(this).parent().css({"background-image":"url("+t+")","background-color":o}),
			$(this).remove()
		}),
	...
	getViewPort:function(){
		var t=window,o="inner";
		return"innerWidth"in window||(o="client",t=document.documentElement||document.body),{width:t[o+"Width"],height:t[o+"Height"]}
	}
}
}();
