<div w3-include-html="<?php echo base_url('business_cafe/content/'); ?>">
...
<div class="row this-month">
    ...
    ?>        <div class="col-sm-4">
            <center>
                <a href="<?php echo base_url('business_cafe/').$articles['reference'];?>">
                    ...
                    <footer>
                        ...
                        <a href="<?php echo base_url('business_cafe/').$articles['reference'];?>" class="btn btn-primary">Read More</a><br /><br />
...
if (isset($_POST['like'])){
    ...
    header("Location:".base_url('business_cafe/'));
    exit();
}
...
?>
    ...
    <!--<?php //echo form_open();?>
        <div>
            <label for="comment-box"><h3>Comment</h3></label>
            <div class="row">
                <div class="col-md-6">
                    <label for="comment-name">Name</label>
                    <input type="text" class="form-control" name="comment-name" placeholder="Enter you name"/>
                </div>
                <div class="col-md-6">
                    <label for="comment-email">Email</label>
                    <input type="text" class="form-control" name="comment-email" placeholder="Enter you Email Address"/>
                </div>
            </div>
            <br />
