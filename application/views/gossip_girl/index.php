...
<?php foreach ($article as $articles) :?>
    ...
    ?>        <div class="col-sm-4">
            <center>
                <a href="<?php echo base_url('gossip_girl/').$articles['reference'];?>">
                    ...
                    <footer>
                        ...
                        <a href="<?php echo base_url('gossip_girl/').$articles['reference'];?>" class="btn btn-primary">Read More</a><br /><br />
...
if (isset($_POST['like'])){
    ...
    header("Location:".base_url('gossip_girl/'));
    exit();
}
